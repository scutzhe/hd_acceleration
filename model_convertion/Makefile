...
ARCH=  -gencode arch=compute_61,code=sm_61 # 1080Ti
...
#CFLAGS=-Wall -Wno-unused-result -Wno-unknown-pragmas -Wfatal-errors -fPIC -O3 -ffast-math -march=armv8-a+crypto -march=cortex-a57+crypto
